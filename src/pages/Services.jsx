    ...
    <>
      ...
      <div className="flex flex-col gap-10 w-full min-h-screen py-20 px-10 md:px-20 justify-center items-center font-space bg-[#F0F8FF]">
        <div className="flex flex-col gap-8 justify-center items-center text-center">
          ...
          <p className="text-[#4E4E4E] w-90 md:w-120">
      ...
      <div className="flex flex-col gap-10 w-full min-h-screen py-20 px-10 md:px-20 justify-center items-center font-space bg-[#F0F8FF]">
        ...
        <div className="flex flex-col md:flex-row justify-start md:justify-between items-start w-full bg-[#ffffff] p-10">
          ...
          <div className="flex flex-col gap-8 justify-start md:justify-center items-start md:items-center bg-[#F0F8FF] rounded-lg p-8 w-70 md:w-100 mt-4 md:mt-0">
            ...
            <button className="w-55 md:w-90 bg-[#28D08A] text-white p-2 rounded-md cursor-pointer">
              Hire an Expert
            </button>
          </div>
        </div>
        <div className="flex flex-col md:flex-row justify-start md:justify-between items-start w-full bg-[#ffffff] p-10">
          ...
          <div className="flex flex-col gap-8 justify-start md:justify-center items-start md:items-center bg-[#F0F8FF] rounded-lg p-8 w-70 mt-5 md:mt-0 md:w-100">
